module.exports = function(crowi) {
  ...
  pageSchema = new mongoose.Schema({
    ...
    joinedUsers: { type: [{type: ObjectId, ref: 'User', index: true }], default: []},
    extended: {
      type: String,
      default: '{}',
      get: function(data) {
  ...
  pageSchema.methods.isJoined = function(userData) {
    ...
    return page.joinedUsers.some(function (v, i) {
      return v._id.toString() == userData._id.toString();
    });
  };
  ...
  pageSchema.methods.removeMember = function(userData) {
    ...
    return new Promise(function(resolve, reject) {
      ...
      page.joinedUsers.pull({ _id: userData._id });
      page.save (function (err, data) {
        if (err) {
          return reject(err);
        }
