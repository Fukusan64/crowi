module.exports = function(crowi, app) {
  ...
  app.post('/_api/pages.joinable'     , accessTokenParser(crowi, app) , loginRequired(crowi, app) , page.api.joinable);
  app.post('/_api/pages.join'         , accessTokenParser(crowi, app) , loginRequired(crowi, app) , page.api.join);
  app.post('/_api/pages.leave'        , accessTokenParser(crowi, app) , loginRequired(crowi, app) , page.api.leave);
  ...
  app.post('/_/exists'               , loginRequired(crowi,app)  ,page.existsPage);
